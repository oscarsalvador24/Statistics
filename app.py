...
if len(columnas_detectadas) > 0:
    st.error("Alerta de Seguridad: El sistema ha bloqueado el analisis porque detecto columnas con posible informacion privada (" + ", ".join(columnas_detectadas) + "). Por favor, elimine estas columnas y vuelva a subir el archivo.")
else:
